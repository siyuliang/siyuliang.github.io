...
title: about
permalink: /
subtitle: 💼 Herring Hall 205, Rice University, Houston, TX, USA
...
I am an Assistant Professor in the [Department of Linguistics](https://linguistics.rice.edu/) at Rice University. My research develops **computational methods** for **multilingual** and **under-resourced speech** grounded in **linguistic theory** and **fairness**. I study how speech models represent and generalize across phonetic and structural variation, and design methods to evaluate and improve their performance across resource levels and dialectal variation. As a linguist, I am particularly interested in studying speech variation through both fieldwork and corpus-based approaches. I am also interested in how computational approaches can be applied to linguistic analysis and documentation, and I have worked on Iranian, Tibeto-Burman, Turkic, Jê, and areally Southeast Asian languages. I actively conduct fieldwork and collaborate with field linguists to build models and resources in real-world documentation settings. 

Before joining Rice, I received my Ph.D. in Computational Linguistics from the [University of Washington](https://linguistics.washington.edu/), where I was advised by Drs. **[Gina-Anne Levow](https://faculty.washington.edu/levow/)** and **[Richard Wright](https://linguistics.washington.edu/people/richard-wright)**. I received my B.A. in Linguistics at [Georgetown University](https://linguistics.georgetown.edu/), with minors in Computer Science and Persian. 
...
If you're a Rice undergrad looking for research opportunities, feel free to contact me. While I'm not accepting Ph.D. students, I'm open to co-advising or being on committees. You can reach me at siyu.liang [@] rice [dot] edu. 
