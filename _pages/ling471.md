...
|  | Jan 8 | Conceptual overview, data science<br/>Guest lecture | - [What is data science?](https://hdsr.mitpress.mit.edu/pub/jhy4g6eg/release/7?readingCollection=72befc2a) | - Online survey (on Canvas)<br/>- Request an account on the Patas cluster |
| 2 | Jan 13 | Basic system and programming concepts | - [Think Python Ch. 1: The Way of the Program](https://greenteapress.com/thinkpython2/html/thinkpython2002.html) | |
|  | Jan 15 | VSCode basics, version control | - [The IMDB reviews dataset paper](https://ai.stanford.edu/~amaas/papers/wvSent_acl2011.pdf)<br/>- [Data statements for NLP](https://olzama.github.io/Ling471/DataStatementsForNLP.pdf)<br/>- [Version control (read conceptually; ignore RStudio stuff, etc.)](https://ourcodingclub.github.io/tutorials/git/) | |
| 3 | Jan 20 | Variables, scope, control flow, FizzBuzz | This looks like a lot, but many of these are only 4 pages long or so.<br/>- [Think Python Ch. 2: Variables, Expressions, and Statements](https://greenteapress.com/thinkpython2/html/thinkpython2003.html)<br/>- [Think Python Ch. 5: Conditionals and Recursion (5.2-5.7)](https://greenteapress.com/thinkpython2/html/thinkpython2006.html)<br/>- [Think Python Ch. 8: Strings (8.1-8.2, 8.4-8.5)](https://greenteapress.com/thinkpython2/html/thinkpython2009.html)<br/>- [Think Python Ch. 10: Lists (10.1-10.5)](https://greenteapress.com/thinkpython2/html/thinkpython2011.html)<br/>- [De Morgan's law](https://web.archive.org/web/20220327221449/https://blog.penjee.com/what-is-demorgans-law-in-programming-answered-with-pics/) | Assignment 1 |
| | Jan 22 | Loops, dictionaries, input/output | - [Think Python Ch. 4: Case Study: Interface Design (4.1-4.2)](https://greenteapress.com/thinkpython2/html/thinkpython2005.html)<br/>- [Think Python Ch. 7: Iteration (7.1-7.4)](https://greenteapress.com/thinkpython2/html/thinkpython2008.html)<br/>- [Think Python Ch. 11: Dicts (11.1-11.3, 11.5)](https://greenteapress.com/thinkpython2/html/thinkpython2012.html)<br/>- [Input/output (7.1-7.2.1)](https://docs.python.org/3/tutorial/inputoutput.html) | |
|4 | Jan 27 | Text processing | - [Regular expressions](https://docs.python.org/3/howto/regex.html)<br/>- [Tokenization](https://web.archive.org/web/20220327222802/https://www.analyticsvidhya.com/blog/2019/07/how-get-started-nlp-6-unique-ways-perform-tokenization/)<br/>  - I would not recommend installing Keras or Gensim just to follow along, though we will probably use Keras later<br/>- [Unicode](https://docs.python.org/3/howto/unicode.html)<br/>- [Modules (6.1-6.4.1)](https://docs.python.org/3/tutorial/modules.html) | |
| | Jan 29 | Text processing, unicode, evaluation, PyCharm settings | - [Think Python Ch. 19: Goodies (19.2-19.3)](https://greenteapress.com/thinkpython2/html/thinkpython2020.html#sec224) | |
| 5 | Feb 3 | Metrics, precision, recall | - [Precision and recall](https://scikit-learn.org/stable/auto_examples/model_selection/plot_precision_recall.html)<br/>  - Can stop when you get to the section headed "In binary classification settings"<br/>- [Precision and recall 2](https://medium.com/@shrutisaxena0617/precision-vs-recall-386cf9f89488) | Assignment 2 |
| | Feb 5 | Data science, probability, maximum likelihood estimation | - [Speech and Language Processing Ch. 3: N-Gram Language Models](https://web.stanford.edu/~jurafsky/slp3/3.pdf)<br/>  - Read for conceptual, not technical understanding | |
| 6| Feb 10 | Statistics, distributions, Gaussian distribution | - Start [stats tutorial](https://www.edureka.co/blog/statistics-and-probability/), read through "measures of spread" | |
| | Feb 12 | Baye's theorem, data frames | - Finish [tutorial](https://www.edureka.co/blog/statistics-and-probability/)<br/>  - Skip the section about R but make sure to read about the Bayes Theorem<br/>  - You can also skip: Entropy and Information Gain; Inferential statistics. Read those if you like (they are generally important), but we probably don't have time for them. | |
| 7 | Feb 17 | Machine learning and matrices, linear regression | - [Regression and classification](https://medium.com/quick-code/regression-versus-classification-machine-learning-whats-the-difference-345c56dd15f7) | Assignment 3 |
