...
| 2 | Sep 1 | Language data and nltk |  | [*Think Python*, Ch. 2: Variables and Statements](https://allendowney.github.io/ThinkPython/chap02.html)<br/>[NLTK Book, Ch. 1, §§1–2](https://www.nltk.org/book/ch01.html)<br/>Optional: [Wikipedia: Zipf’s law](https://en.wikipedia.org/wiki/Zipf%27s_law) | HW 1 released |
|  | Sep 3 | Control flow and functions |  | [*Think Python*, Ch. 5: Conditionals and Recursion (recursion optional)](https://allendowney.github.io/ThinkPython/chap05.html)<br/>[*Think Python*, Ch. 7: Iteration and Search](https://allendowney.github.io/ThinkPython/chap07.html)<br/>[NLTK Book, Ch. 1, §4: Making Decisions and Taking Control](https://www.nltk.org/book/ch01.html) | |
| 3 | Sep 8 | Working with text: strings, dictionaries, and files |  | [*Think Python*, Ch. 10: Dictionaries](https://allendowney.github.io/ThinkPython/chap10.html)<br/>[NLTK Book, Ch. 1, §3: Computing with Language: Simple Statistics](https://www.nltk.org/book/ch01.html)<br/>Optional: [*Think Python*, Ch. 9: Lists](https://allendowney.github.io/ThinkPython/chap09.html) and [Ch. 13, first half: Files](https://allendowney.github.io/ThinkPython/chap13.html) — both walked through in class | |
|  | Sep 10 | Functions, slicing, and text normalization |  | [*Think Python*, Ch. 3: Functions](https://allendowney.github.io/ThinkPython/chap03.html)<br/>[*Think Python*, Ch. 8: Strings (stop before the regular-expression sections)](https://allendowney.github.io/ThinkPython/chap08.html)<br/>Optional: [*Think Python*, Ch. 6: Return Values](https://allendowney.github.io/ThinkPython/chap06.html) — its key point (return vs. print) is covered in class<br/>Optional: [*Think Python* (2nd ed.), Appendix A: Debugging](https://greenteapress.com/thinkpython2/html/thinkpython2021.html) — self-help for when code breaks | HW 1 due; HW 2 released |
...
|  | Oct 1 | N-gram language models |  | [Jurafsky & Martin, Ch. 3, §§3.1–3.6: N-gram Language Models](https://web.stanford.edu/~jurafsky/slp3/3.pdf) (§3.7 optional) | |
