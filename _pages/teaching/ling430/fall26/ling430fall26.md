...
|  | Aug 27 | Course setup and Python basics | link | [Ma et al. (2025), “Not Everyone Wins with LLMs”](https://arxiv.org/abs/2509.21890)<br/>[*Think Python*, Ch. 1: Programming as a Way of Thinking](https://allendowney.github.io/ThinkPython/chap01.html) (covered in class; no need to read ahead, revisit after if anything is unclear) | |
| 2 | Sep 1 | Python for language data: counting a corpus |  | [*Think Python*, Ch. 2: Variables and Statements](https://allendowney.github.io/ThinkPython/chap02.html)<br/>[NLTK Book, Ch. 1, §§1–2](https://www.nltk.org/book/ch01.html)<br/>Optional: [Wikipedia: Zipf’s law](https://en.wikipedia.org/wiki/Zipf%27s_law) | HW 1 released |
|  | Sep 3 | Python building blocks: control flow and functions |  | [*Think Python*, Ch. 3: Functions](https://allendowney.github.io/ThinkPython/chap03.html)<br/>[*Think Python*, Ch. 5: Conditionals and Recursion (recursion optional)](https://allendowney.github.io/ThinkPython/chap05.html)<br/>[*Think Python*, Ch. 6: Return Values](https://allendowney.github.io/ThinkPython/chap06.html)<br/>[*Think Python*, Ch. 7: Iteration and Search](https://allendowney.github.io/ThinkPython/chap07.html)<br/>[NLTK Book, Ch. 1, §4: Making Decisions and Taking Control](https://www.nltk.org/book/ch01.html) | |
| 3 | Sep 8 | Working with text: strings, dictionaries, and files |  | [*Think Python*, Ch. 8: Strings (stop before the regular-expression sections)](https://allendowney.github.io/ThinkPython/chap08.html)<br/>[*Think Python*, Ch. 9: Lists](https://allendowney.github.io/ThinkPython/chap09.html)<br/>[*Think Python*, Ch. 10: Dictionaries](https://allendowney.github.io/ThinkPython/chap10.html)<br/>[*Think Python*, Ch. 13, first half: Files](https://allendowney.github.io/ThinkPython/chap13.html)<br/>[NLTK Book, Ch. 1, §3: Computing with Language: Simple Statistics](https://www.nltk.org/book/ch01.html) | |
|  | Sep 10 | Debugging and reproducible workflows |  | [*Think Python* (2nd ed.), Appendix A: Debugging](https://greenteapress.com/thinkpython2/html/thinkpython2021.html)<br/>[VS Code: Getting Started with Python](https://code.visualstudio.com/docs/python/python-tutorial)<br/>Optional: [MIT Missing Semester: Introduction to the Shell](https://missing.csail.mit.edu/2026/course-shell/)<br/>Optional: [MIT Missing Semester: Version Control and Git](https://missing.csail.mit.edu/2026/version-control/) | HW 1 due; HW 2 released |
| 4 | Sep 15 | Tokenization and regular expressions |  | [Jurafsky & Martin, Ch. 2, §§2.1–2.4: Regular Expressions, Words, Corpora](https://web.stanford.edu/~jurafsky/slp3/2.pdf)<br/>[*Think Python*, Ch. 8: the regular-expression sections this time](https://allendowney.github.io/ThinkPython/chap08.html)<br/>Optional: [RegexOne (interactive practice)](https://regexone.com) | |
|  | Sep 17 | Unicode and subword tokenization |  | [Spolsky (2003), “The Absolute Minimum Every Software Developer Must Know About Unicode”](https://www.joelonsoftware.com/2003/10/08/the-absolute-minimum-every-software-developer-absolutely-positively-must-know-about-unicode-and-character-sets-no-excuses/)<br/>[Python Unicode HOWTO](https://docs.python.org/3/howto/unicode.html)<br/>[Jurafsky & Martin, Ch. 2, §2.5: Byte-Pair Encoding](https://web.stanford.edu/~jurafsky/slp3/2.pdf) | |
