...
- **HW 2: Palindrome recognizer.** Build a palindrome recognizer using functions, loops, and string operations; document how your cleaning choices hold up across different scripts and languages.
...
|  | Sep 3 | [Control flow and dictionaries](https://siyuliang.github.io/ling430fall26/slides/lec02b.pdf) | [link](https://colab.research.google.com/github/siyuliang/ling430fall26/blob/main/classwork/class02b.ipynb) | [*Think Python*, Ch. 5, §§5.1–5.7: Conditionals](https://allendowney.github.io/ThinkPython/chap05.html)<br/>[*Think Python*, Ch. 7, §§7.1 and 7.3–7.5: Loops, Updating, Counting](https://allendowney.github.io/ThinkPython/chap07.html)<br/>[*Think Python*, Ch. 10, §§10.1–10.5: Dictionaries and Counters](https://allendowney.github.io/ThinkPython/chap10.html) | |
| 3 | Sep 8 | [Language data and nltk](https://siyuliang.github.io/ling430fall26/slides/lec03a.pdf) | [link](https://colab.research.google.com/github/siyuliang/ling430fall26/blob/main/classwork/class03a.ipynb) | [NLTK Book, Ch. 1, §§1 and 3: Computing with Language — Texts, Words, and Simple Statistics](https://www.nltk.org/book/ch01.html)<br/>Optional: [Wikipedia: Zipf’s law](https://en.wikipedia.org/wiki/Zipf%27s_law) | |
|  | Sep 10 | [Functions and files](https://siyuliang.github.io/ling430fall26/slides/lec03b.pdf) | [link](https://colab.research.google.com/github/siyuliang/ling430fall26/blob/main/classwork/class03b.ipynb) | [*Think Python*, Ch. 3: Functions](https://allendowney.github.io/ThinkPython/chap03.html)<br/>[W3Schools: Python File Open](https://www.w3schools.com/python/python_file_open.asp) | HW 1 due; [HW 2](https://colab.research.google.com/github/siyuliang/ling430fall26/blob/main/homework/hw2.ipynb) released |
| 4 | Sep 15 | [Regular expression and tokenization](https://siyuliang.github.io/ling430fall26/slides/lec04a.pdf) | [link](https://colab.research.google.com/github/siyuliang/ling430fall26/blob/main/classwork/class04a.ipynb) | [Jurafsky & Martin, Ch. 2, §§2.1, 2.6, and 2.8](https://web.stanford.edu/~jurafsky/slp3/2.pdf)<br/>Optional: [RegexOne (interactive practice)](https://regexone.com) | |
|  | Sep 17 | [Encoding and tokenization](https://siyuliang.github.io/ling430fall26/slides/lec04b.pdf) | [link](https://colab.research.google.com/github/siyuliang/ling430fall26/blob/main/classwork/class04b.ipynb) | [Jurafsky & Martin, Ch. 2, §§2.3–2.4: Unicode and Byte-Pair Encoding](https://web.stanford.edu/~jurafsky/slp3/2.pdf) <br/> Optional: [Python Unicode HOWTO](https://docs.python.org/3/howto/unicode.html)| HW 2 due |
| 5 | Sep 22 | [Computational morphology](https://siyuliang.github.io/ling430fall26/slides/lec05a.pdf) | [link](https://colab.research.google.com/github/siyuliang/ling430fall26/blob/main/classwork/class05a.ipynb) | [Jurafsky & Martin, Ch. 2, §2.2: Morphemes: Parts of Words](https://web.stanford.edu/~jurafsky/slp3/2.pdf) <br/> [NLTK Book, Ch. 3, §3.6: Normalizing Text](https://www.nltk.org/book/ch03.html#sec-normalizing-text) | |
|  | Sep 24 | [Evaluation and edit distance]((https://siyuliang.github.io/ling430fall26/slides/lec05b.pdf)) | [link](https://colab.research.google.com/github/siyuliang/ling430fall26/blob/main/classwork/class05b.ipynb) | [Google ML Crash Course: Accuracy, Precision, and Recall](https://developers.google.com/machine-learning/crash-course/classification/accuracy-precision-recall) (including the F1 score)<br/>[Jurafsky & Martin, Ch. 2, §2.9: Minimum Edit Distance](https://web.stanford.edu/~jurafsky/slp3/2.pdf) | [HW 3](https://colab.research.google.com/github/siyuliang/ling430fall26/blob/main/homework/hw3.ipynb) released |
...
|  | Oct 1 | N-gram language models (asynchronous) |  | [Jurafsky & Martin, Ch. 3, §§3.1–3.6: N-gram Language Models](https://web.stanford.edu/~jurafsky/slp3/3.pdf) (§3.7 optional) | HW 3 due |
...
|  | Oct 8 | Text classification with Naive Bayes |  | [pandas: What Kind of Data Does pandas Handle?](https://pandas.pydata.org/docs/getting_started/intro_tutorials/01_table_oriented.html)<br/>[Jurafsky & Martin, Appendix B, §§B.1-B.2: Naive Bayes Classification](https://web.stanford.edu/~jurafsky/slp3/B.pdf) | HW 4 released |
| 8 | Oct 13 | **No class: Midterm Recess** |  | | |
|  | Oct 15 | Logistic regression |  | [Jurafsky & Martin, Ch. 4, §§4.1–4.7 and 4.9: Logistic Regression and Text Classification](https://web.stanford.edu/~jurafsky/slp3/4.pdf) | HW 4 due |
...
|  | Oct 22 | Part-of-speech tagging and error analysis |  | [Jurafsky & Martin, Ch. 18, §§18.1–18.2 and 18.4: Word Classes, POS Tagging, HMM Taggers](https://web.stanford.edu/~jurafsky/slp3/18.pdf) | HW 5 released |
...
|  | Oct 29 | Grammars and parsing |  | [Jurafsky & Martin, Ch. 19, §§19.1–19.6: Context-Free Grammars and Constituency Parsing](https://web.stanford.edu/~jurafsky/slp3/19.pdf) | HW 5 due |
