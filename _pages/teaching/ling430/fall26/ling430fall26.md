...
|  | Sep 24 | Evaluation and edit distance |  | [Google ML Crash Course: Accuracy, Precision, and Recall](https://developers.google.com/machine-learning/crash-course/classification/accuracy-precision-recall) (including the F1 score)<br/>[Jurafsky & Martin, Ch. 2, §2.9: Minimum Edit Distance](https://web.stanford.edu/~jurafsky/slp3/2.pdf) | HW 3 released |
