...
| 5 | Sep 22 | Computational morphology |  | [Jurafsky & Martin, Ch. 2, §2.2: Morphemes: Parts of Words](https://web.stanford.edu/~jurafsky/slp3/2.pdf) <br/> [NLTK Book, Ch. 3, §3.6: Normalizing Text](https://www.nltk.org/book/ch03.html#sec-normalizing-text) | |
|  | Sep 24 | Evaluation and edit distance |  | [scikit-learn: Precision, Recall, and F-measures](https://scikit-learn.org/stable/modules/model_evaluation.html#precision-recall-f-measure-metrics)<br/>[Jurafsky & Martin, Ch. 2, §2.9: Minimum Edit Distance](https://web.stanford.edu/~jurafsky/slp3/2.pdf) | HW 3 released |
